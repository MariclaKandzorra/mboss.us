...
const formRange= ('from ${formStartDate} to ${formEndDate}');

const formConsStartDate= console.log(formStartDate);
        ...
        <div>
			...
			<main className='flex'>
				<section className='flex-grow pt-14 px-5'>
					<p className='text-xs'>300+ Venues {formRange} from {formConsStartDate} at {formTime1} to {formEndDate} at {formTime2} for {noOfGuests} Event Visitors</p>
